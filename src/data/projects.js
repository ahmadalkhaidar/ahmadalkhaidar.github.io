...
import UPJEOFFICEApp from '../images/project/upj_e-office.png';
import UPJEOFFICE1 from '../images/project/upj_e-office-1.png';
import UPJEOFFICE2 from '../images/project/upj_e-office-2.png';
import UPJEOFFICE3 from '../images/project/upj_e-office-3.png';
import UPJEOFFICE4 from '../images/project/upj_e-office-4.png';
...
import UPJSIMPUL4 from '../images/project/upj_simpul-4.png';
import UPJSIMPUL5 from '../images/project/upj_simpul-5.png';
import UPJSIMPUL6 from '../images/project/upj_simpul-6.png';
import UPJSIMPUL7 from '../images/project/upj_simpul-7.png';
import UPJSIMPUL8 from '../images/project/upj_simpul-8.png';
import UPJSIMPUL9 from '../images/project/upj_simpul-9.png';

import UPJSPAApp from '../images/project/upj_spa.jpeg';
		...
		ProjectInfo: {
			...
			CompanyInfo: [
				...
				},
				{
					id: 3,
					title: 'Website',
					details: 'https://e-office.upj.ac.id',
					link: 'https://e-office.upj.ac.id',
				},
			],
			ObjectivesHeading: 'Objective',
			ObjectivesDetails:
				'Designing and building an E-Office system at Pembangunan Jaya University which is used to manage the process of borrowing infrastructure, borrowing equipment and submitting documents.',
			Technologies: [
				{
					title: 'Tools & Technologies',
					techs: [
			...
			ProjectDetails: [
				{
					...
					details: `<ol style="list-style: decimal;margin-left:20px;font-size:14px;">
								<li>
									...
									<br>
									Designing a user-friendly interface for the system that is easy to use and navigate for employees and students
								</li>
								<li>
								...
								<li>
									...
									<br>
									Ensuring the security and integrity of employee data, student data and performance records through encryption and access controls.
								</li>
								<li>
			...
			CompanyInfo: [
				{
					id: 1,
					title: 'Name',
					details: 'Sistem Kepegawaian Unggul UPJ',
				},
				{
					id: 2,
					title: 'As',
				...
				},
				{
					...
					link: 'https://simpul2.upj.ac.id',
				},
			],
			ObjectivesHeading: 'Objective',
			ObjectivesDetails:
				'Designing and building Sistem Kepegawaian Unggul system at Universitas Pembangunan Jaya which is used to manage personnel processes, such as Attendance, Leave and Permit Application, KPI Assessment Process and Form Submission.',
			Technologies: [
				{
					title: 'Tools & Technologies',
					techs: [
			...
			CompanyInfo: [
				{
					id: 1,
					title: 'Name',
					details: 'Sistem Pencairan Anggaran UPJ',
				},
				{
					id: 2,
					title: 'As',
