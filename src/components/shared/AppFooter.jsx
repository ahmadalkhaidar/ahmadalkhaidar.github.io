...
const socialLinks = [
	{
		id: 1,
		icon: <FiGithub />,
		url: 'https://github.com/ahmadalkhaidar',
	},
	{
		id: 2,
		icon: <FiFacebook />,
		url: 'https://www.facebook.com/ahmadalkhaidar/',
	},
	{
		id: 3,
		icon: <FiLinkedin />,
		url: 'https://www.linkedin.com/in/ahmadalkhaidar/',
	},
	{
		id: 4,
		icon: <FiInstagram />,
		url: 'https://www.instagram.com/ahmadalkhaidar2/',
	}
];
